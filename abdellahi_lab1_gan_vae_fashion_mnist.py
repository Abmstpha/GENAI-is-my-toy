# -*- coding: utf-8 -*-
"""Abdellahi lab1_gan_vae_Fashion_MNIST.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hlzGIts560Rv0t7ALxdcQkE7vWS2JNt-
"""
...
GAN_PICS_DIR = '/content/drive/MyDrive/GAN_PICS/Fashion-mnist'
...
for current_latent_dim in LATENT_OPTIONS:
    ...
    if SCIPY_OK:
        ...
        for i in range(0, len(all_vae_samples), BATCH):
            ...
            fake_feats_vae.append(f.detach().cpu()) # Added .detach() here
